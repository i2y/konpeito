# Castella UI - All Widgets Demo (NativeFrame / SDL3 + Skia Metal)
#
# Same as all_widgets_demo.rb but uses NativeFrame instead of JWMFrame.
# Comprehensive showcase of all Castella UI widgets and chart types
# organized into 9 tabbed pages.
#
# Run: ruby examples/castella_ui/native_all_widgets_demo.rb
...
frame = NativeFrame.new("All Widgets Demo", 900, 700)
