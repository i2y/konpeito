# Castella UI - Animation Demo (NativeFrame / SDL3 + Skia Metal)
#
# Same as animation_demo.rb but uses NativeFrame instead of JWMFrame.
# Demonstrates the animation system with various easing functions
# Run: ruby examples/castella_ui/native_animation_demo.rb
...
class AnimationDemo < Component
  ...
  def view
    Column(
      ...
      Text("Click the button to animate all bars").font_size(12.0).color($theme.text_secondary),
      Divider(),
...
frame = NativeFrame.new("Animation Demo", 600, 500)
