# Castella UI - DataTable Demo (NativeFrame / SDL3 + Skia Metal)
#
# Same as data_table_demo.rb but uses NativeFrame instead of JWMFrame.
# Run: ruby examples/castella_ui/native_data_table_demo.rb
...
class DataTableDemo < Component
  def view
    ...
    Column(
      ...
      Text("Click headers to sort. Click rows to select.").font_size(12.0).color($theme.text_secondary),
      Divider(),
...
frame = NativeFrame.new("DataTable Demo", 700, 600)
