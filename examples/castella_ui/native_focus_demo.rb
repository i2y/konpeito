# Castella UI - Focus Demo (NativeFrame / SDL3 + Skia Metal)
#
# Same as focus_demo.rb but uses NativeFrame instead of JWMFrame.
# Tests Tab/Shift+Tab focus navigation between Input fields.
# Run: ruby examples/castella_ui/native_focus_demo.rb
...
frame = NativeFrame.new("Focus Demo", 400, 400)
