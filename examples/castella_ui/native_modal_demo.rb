# Castella UI - Modal Demo (NativeFrame / SDL3 + Skia Metal)
#
# Same as modal_demo.rb but uses NativeFrame instead of JWMFrame.
# Run: ruby examples/castella_ui/native_modal_demo.rb
...
frame = NativeFrame.new("Modal Demo", 500, 400)
